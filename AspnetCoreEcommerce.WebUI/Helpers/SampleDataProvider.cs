...
namespace AspnetCoreEcommerce.WebUI.Helpers
{
    public static class SampleDataProvider
    {
        ...
        #region TestDataSeed
        private static async Task TestDataSeed(ApplicationDbContext context, IConfiguration configuration)
        {
            #region RemoveRange
        ...
        private static async Task SeedAdminAccount(ApplicationDbContext context, IConfiguration configuration)
        {
        ...
        private static async Task SeedTestAccount(ApplicationDbContext context, IConfiguration configuration)
        {
            // user1
