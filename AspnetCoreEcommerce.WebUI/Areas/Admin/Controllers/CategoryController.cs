...
namespace AspnetCoreEcommerce.WebUI.Areas.Admin.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public CategoryController(ICategoryService categoryService, IHttpContextAccessor httpContextAccessor, ViewHelper viewHelper, DataHelper dataHelper, IMapper mapper)
        {
